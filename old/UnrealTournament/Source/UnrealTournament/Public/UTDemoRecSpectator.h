...
class UNREALTOURNAMENT_API AUTDemoRecSpectator : public AUTPlayerController
{
	...
	virtual void DemoNotifyCausedHit(APawn* InstigatorPawn, AUTCharacter* HitPawn, uint8 AppliedDamage, FVector Momentum, const FDamageEvent& DamageEvent, bool bArmorDamage, bool bOverhealth);
